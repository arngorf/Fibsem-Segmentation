...
def make_model(num_classes,
               name='test_non_linear_resampling',
               **kwargs):
    ...
    model = all_preprocessing(model, non_linear_resampling=True, input_shape=k_input_shape, target_shape=target_shape, force_use_in_test_phase=True, **kwargs)
